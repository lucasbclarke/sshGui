...
This program now also works on Windows systems, by specifying either "powershell" or "cmd" in the config file.
However, this code may or may not work on Mac systems, I do not know as I have no way to test this, at the moment.
